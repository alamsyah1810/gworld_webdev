...
$query=mysqli_query($con,"select v.nominal_voucher, g.nama_game, count(d.id_hash) as jumlah FROM voucher v, game g, detail_voucher d where v.id_game=g.id_game and d.id_voucher=v.id_voucher and d.status_voucher=2 and g.jenis_game=2 group by d.id_voucher order by jumlah desc");
?>
...
<div style='width: 300px;float:left:background-color:#eee;'>
 ...
 <div style="position: relative; left: 300px; bottom: 588px;" class="table-responsive">
                <table class="table table-striped">
                  <thead>
                  <tr>
                      <th colspan="3">Voucher top-up sering dibeli</th>
                    </tr>
                    <tr>
                      <td>Nominal</td>
                      <td>Game</td>
