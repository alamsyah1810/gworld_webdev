...
$query=mysqli_query($con,"SELECT MAX(harga_voucher) as 'harga voucher termurah' , nominal_voucher, nama_game FROM voucher v, game g WHERE v.id_game = g.id_game group by nama_game, nominal_voucher ORDER BY `harga voucher termurah` ASC");
?>
<html>

<head>
  <title>Voucher Termurah</title>
</head>
<style>
  table,
  th,
...
<div style='width: 300px;float:left:background-color:#eee;'>
 ...
 <div style="position: relative; left: 300px; bottom: 588px;" class="table-responsive">
                <table class="table table-striped">
                  <thead>
                    <tr>
                    <th style="text-align:center;" colspan="3">Voucher termurah</th>
                    </tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                    <td style="text-align:center;"><?php echo $tampung['harga voucher termurah']?></td>
