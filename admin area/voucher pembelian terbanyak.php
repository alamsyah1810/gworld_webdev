...
$query=mysqli_query($con,"select g.nama_game,count(v.id_voucher) as `uu`,v.id_voucher, nama_jenisgame from jenis_game j,cart c,game g,voucher v where g.id_game=v.id_game and c.id_voucher=v.id_voucher and j.id_jenisgame = g.id_jenisgame group by id_voucher order by uu desc
");
?>
